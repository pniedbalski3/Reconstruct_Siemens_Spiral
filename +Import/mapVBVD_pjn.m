function twix_obj = mapVBVD_pjn(filename,varargin)

%  Reads Siemens raw .dat file from VB/VD MRI raw data.
% 
%  Requires twix_map_obj_pjn.m
% 
...
%                          twix_map_obj_pjn.m now stores the memory position of
...
%  Philipp Ehses 27.08.12, speed optimizations (avoiding of .-subsref
%  calls)
